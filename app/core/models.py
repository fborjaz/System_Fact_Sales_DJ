...
class Supplier(models.Model):
  ...
  latitude = models.DecimalField(verbose_name='Latitud', max_digits=9, decimal_places=6, null=True, blank=True)
  longitude = models.DecimalField(verbose_name='Longitud', max_digits=9, decimal_places=6, null=True, blank=True)
  active = models.BooleanField(verbose_name='Activo', default=True)
